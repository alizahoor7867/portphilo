...
const practiceProjects = [
  ...
  },
  {
    ...
    description: 'Classified ads platform with product listings, categories, search, and user authentication.',
  ...
  },
  {
    ...
    description: 'Full social media app with posts, likes, comments, friend requests, and profile pages.',
    tech: ['React', 'Node.js', 'MongoDB'],
    icon: '👥',
  ...
  },
  {
    ...
    description: 'Gig-based freelance platform with seller profiles, service listings, orders, and reviews.',
    tech: ['React', 'Node.js', 'MongoDB'],
    icon: '💼',
  ...
  },
  {
    ...
    description: 'Fast food restaurant website with menu display, cart, and order placement.',
    tech: ['HTML', 'CSS', 'JavaScript'],
    icon: '🍗',
  ...
  {
    id: 13,
    title: 'AI Language Detection Tool',
    description: 'AI-powered tool that detects the language of any input text instantly using machine learning.',
    tech: ['Python', 'React', 'ML', 'NLP'],
    icon: '🤖',
  ...
  {
    id: 14,
    title: 'Currency Detection Tool',
    description: 'Smart tool to detect and identify currency from images or text using AI algorithms.',
    tech: ['Python', 'React', 'AI', 'OpenCV'],
    icon: '💱',
  ...
  {
    id: 15,
    title: 'InDrive Mobile App',
    description: 'Ride-hailing mobile application inspired by InDrive with fare negotiation and real-time tracking.',
